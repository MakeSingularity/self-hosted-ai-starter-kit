...
def show_next_steps():
    ...
    print("   python examples/environment_detector.py")
    print()
    print("3. 🌐 Open n8n in your browser:")
    print("   http://localhost:5678")
    print()
    print("4. 🤖 Import AI Setup & Monitoring Workflow:")
    print("   n8n/demo-data/workflows/ai-setup-and-monitoring-workflow.json")
    print("   This provides intelligent setup automation and service monitoring!")
    print()
    print("5. � View AI Analysis Reports:")
    print("   shared/ai-setup-status-report.txt - Human-readable status")
    print("   shared/ai-setup-status-report.json - Programmatic access")
    print()
    print("6. 📚 API Documentation:")
    print("   http://localhost:8000/docs - Main API")
    print("   http://localhost:8002/docs - Environment Detection")
    print()
    print("7. 🔧 Additional Workflows:")
    print("   n8n/demo-data/workflows/oliver-service-status-checker.json")
    print("   n8n/demo-data/workflows/environment-aware-ai-agent.json")
    print()
    print("8. 📖 Read the documentation:")
    print("   README.md - Main guide")
    print("   docs/AI_SETUP_MONITORING_WORKFLOW.md - Workflow guide")
    print("   docs/ENVIRONMENT_DETECTION.md - Environment detection")
    print()
